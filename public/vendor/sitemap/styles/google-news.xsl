...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                xmlns:news="http://www.google.com/schemas/sitemap-news/0.9" exclude-result-prefixes="s">
    <xsl:template match="/">
        <html lang="en">
            <head>
                <meta charset="utf-8"/>
  ...
  return false;
            ...
            <body>
                <div id="content">
                    ...
                    <p class="expl">Generated by <a href="https://gitlab.com/Laravelium/Sitemap" target="_blank"
                                                    title="Sitemap generator for Laravel">laravelium-sitemap</a>. This
                        is styled xml sitemap (for Google News), sorted by update date.
                    </p>
